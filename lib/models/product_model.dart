...
//
//     final elfProducts = elfProductsFromJson(jsonString);

import 'dart:convert';

List<ElfProducts> elfProductsFromJson(String str) =>
    List<ElfProducts>.from(json.decode(str).map((x) => ElfProducts.fromJson(x)));

String elfProductsToJson(List<ElfProducts> data) =>
...
class ElfProducts {
  ...
  factory ElfProducts.fromJson(Map<String, dynamic> json) => ElfProducts(
    id: json["id"],
